...
class Admin extends Controller
{
    ...
    function CreateQuestion() 
    {
        ...
        $isSuccess = $this->question_model->CreateQuestion(
            ...
            strip_tags($_POST['type_question']),
            strip_tags($_POST['point_question']),
            strip_tags($_POST['answer_A']),
            strip_tags($_POST['answer_B']),
            strip_tags($_POST['answer_C']),
            strip_tags($_POST['answer_D']),
            $_POST['result']);
